...
def test_operator_run_pair_case_check_resolves_cases_and_emits_output_notes(
    tmp_path: Path,
) -> None:
    ...
    completed = subprocess.run(
        [
            ...
            (
                ...
                f"source {str(REPO_ROOT / 'ops/ci/lib_operator_pair_case_check.sh')!r}\n"
                ...
                "/tmp/fake-cases "
                "/tmp/default-output "
                "VULD_TEST_NAMED_DIRECT_HELPER run_named_direct_case_set.sh "
                "VULD_TEST_PRESET_HELPER run_named_preset_case_set.sh "
                "VULD_TEST_DIRECT_HELPER run_direct_validation_chain.sh "
...
def test_operator_run_pair_case_check_rejects_missing_preset_helper(tmp_path: Path) -> None:
