        ...
        json.dumps(
            {
                ...
                "live_positive_ready_item_count": payload.get("live_positive_ready_item_count"),
                "live_positive_blocked_item_count": payload.get("live_positive_blocked_item_count"),
